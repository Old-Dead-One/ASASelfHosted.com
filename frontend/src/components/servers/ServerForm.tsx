...
import { listMyClusters, type Cluster } from '@/lib/api'
...
export interface ServerFormData {
    ...
    join_instructions_pc: string
    join_instructions_console: string
    mod_list: string
    rates: string
    wipe_info: string
    game_mode: GameMode | ''
...
export function ServerForm({
    ...
    const [formData, setFormData] = useState<ServerFormData>({
        ...
        join_instructions_pc: initialData?.join_instructions_pc || '',
        join_instructions_console: initialData?.join_instructions_console || '',
        ...
        <form onSubmit={handleSubmit} className={FORM_SPACE}>
            ...
            <section className="relative overflow-hidden rounded-lg tek-border">
                ...
                <div className="relative p-3 space-y-3 bg-background/65 backdrop-blur-[1px]">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <textarea id="description" value={formData.description} onChange={(e) => setFormData({ ...formData, description: e.target.value })} rows={2} maxLength={250} className="input-tek-auto !h-auto min-h-[4.5rem] resize-none pr-14 pb-6" />
                            <p className="absolute bottom-2 right-2 text-xs text-muted-foreground pointer-events-none" aria-hidden>{formData.description.length}/250</p>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <input id="mod_list" type="text" value={formData.mod_list} onChange={(e) => setFormData({ ...formData, mod_list: e.target.value })} placeholder="123456, 789012" maxLength={500} className="input-tek" />
                </div>
                <div>
            ...
            <section className="relative overflow-hidden rounded-lg tek-border">
                ...
                <div className="relative p-3 space-y-3 bg-background/65 backdrop-blur-[1px]">
                    ...
                    <div className={`grid grid-cols-1 md:grid-cols-2 ${FORM_GAP} md:items-start`}>
                        <div>
                            <label htmlFor="join_instructions_pc" className="label-tek">PC Join Instructions</label>
                            <textarea id="join_instructions_pc" value={formData.join_instructions_pc} onChange={(e) => setFormData({ ...formData, join_instructions_pc: e.target.value })} rows={2} maxLength={400} className="input-tek-auto !h-auto min-h-[4.5rem] resize-none" />
                        </div>
                        <div>
                            <label htmlFor="join_instructions_console" className="label-tek">Console Join Instructions</label>
                            <textarea id="join_instructions_console" value={formData.join_instructions_console} onChange={(e) => setFormData({ ...formData, join_instructions_console: e.target.value })} rows={2} maxLength={400} className="input-tek-auto !h-auto min-h-[4.5rem] resize-none" />
                        </div>
            ...
            <div className="border-t border-input/60 pt-4 mt-2 flex gap-3">
                <Button
                    type="submit"
                    variant="primary"
                    size="sm"
