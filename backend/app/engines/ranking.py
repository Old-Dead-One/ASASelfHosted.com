...
def compute_ranking_score(server_data: ServerRankingData) -> float:
    ...
    if uptime_percent is not None:
        ...
        if uptime_percent > UPTIME_DIMINISHING_THRESHOLD:
            ...
            normalized_excess = math.log(1 + excess) / math.log(6) * 5.0  # Normalize to [0, 5]
    ...
    ranking_score = quality_component + uptime_component + activity_component - anomaly_penalty
