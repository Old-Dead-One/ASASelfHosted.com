...
class TestStaleServerDecay:
    ...
    def test_server_goes_offline_metrics_decay(self, grace_window):
        ...
        uptime_online = compute_uptime_percent("server-1", heartbeats_good, grace_window, window_hours=24)
        confidence_online = compute_confidence("server-1", heartbeats_good, grace_window)
        ...
        assert confidence_online in ("green", "yellow")  # May be yellow with only 2 heartbeats
        ...
        uptime_stale = compute_uptime_percent("server-1", heartbeats_stale, grace_window, window_hours=24)
        confidence_stale = compute_confidence("server-1", heartbeats_stale, grace_window)
    ...
    def test_confidence_degrades_green_to_yellow_to_red(self, grace_window):
        ...
        confidence_green = compute_confidence("server-1", heartbeats_green, grace_window)
        ...
        heartbeats_yellow: list[Heartbeat] = [
            {
                "id": "hb-1",
                "server_id": "server-1",
                "received_at": now - timedelta(seconds=grace_window + 100),  # Beyond grace, within 2*grace
                "status": "online",
                "map_name": None,
                "players_current": None,
                "players_capacity": None,
        ...
        confidence_yellow = compute_confidence("server-1", heartbeats_yellow, grace_window)
        ...
        heartbeats_red: list[Heartbeat] = [
            {
                "id": "hb-1",
                "server_id": "server-1",
                "received_at": now - timedelta(seconds=2 * grace_window + 100),  # Beyond 2*grace
                "status": "offline",
                "map_name": None,
                "players_current": None,
                "players_capacity": None,
    ...
    def test_uptime_decreases_over_time(self, grace_window):
        ...
        uptime_initial = compute_uptime_percent("server-1", heartbeats_initial, grace_window, window_hours=24)
        ...
        uptime_later = compute_uptime_percent("server-1", heartbeats_later, grace_window, window_hours=24)
    ...
    def test_quality_score_decreases(self, grace_window):
        ...
        uptime_good = compute_uptime_percent("server-1", heartbeats_good, grace_window, window_hours=24)
        ...
        uptime_poor = compute_uptime_percent("server-1", heartbeats_poor, grace_window, window_hours=24)
