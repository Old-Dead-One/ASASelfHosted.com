...
def test_canonicalize_heartbeat_envelope_deterministic():
    ...
    assert result1 == result2, "Canonicalization should be deterministic regardless of key order"
...
def test_canonicalize_heartbeat_envelope_exact_rfc3339_utc():
    ...
    assert '"timestamp":"2026-01-22T21:05:00Z"' in result2_str or '"timestamp":"2026-01-22T21:05:00Z"' in result2_str
